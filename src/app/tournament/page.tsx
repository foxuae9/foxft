      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-8 space-y-4">
          <div className="flex justify-center gap-4">
            ...
            <a
              href="https://fighter.foxuae35.com/"
              className="inline-block bg-gradient-to-r from-orange-500 to-orange-400 text-white px-6 py-2 rounded-lg hover:from-orange-600 hover:to-orange-500 transition-colors"
            >
              التسجيل في البطولة
            </a>
          </div>
